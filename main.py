...
function def cel_to_fahren(tempreture_in_celsium): - Take temperature in Celsius and convert to Fahrenheit
From Celsius  to Fahrenheit
Temp: 20 C
20 * (9/5) + 32 = 68 F


function def fahren_to_cel(temprutere_in_fahren): - Take temperature in Fahrenheit and convert to Celsius
...
parser.add_argument("-f", "--fahrenheit", help="Take temperature in Fahrenheit and convert to Celsius")
parser.add_argument("-c", "--celsius", help="Take temperature in Celsius and convert to Fahrenheit")
...
if args.verbose:
    ...
    print(fahren_to_cel(float(args.fahrenheit)))
elif args.celsius:
    # print(f"{args.celsius} Celsius")
    print(cel_to_fahren(float(args.celsius)))
else:
